  ...
  return (
    <section className="py-20 px-4 md:px-8 bg-white border-b border-slate-100 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-14 p-8 rounded-3xl bg-gradient-to-r from-[#2D3094] to-[#1a1b55] text-white flex flex-col md:flex-row items-center justify-between gap-6 text-left shadow-xl">
          <div>
          ...
          <button
            ...
            className="bg-[#ED008C] hover:bg-[#d4007d] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 rounded-full shadow-lg transition-all hover:scale-105 shrink-0"
          >
            Start Your Project
          </button>
        </div>
