  ...
  return (
    <section className={`py-16 md:py-20 px-4 md:px-8 font-sans ${className || 'bg-[#F7F8FA] border-b border-slate-200/80'}`}>
      <div className="max-w-4xl mx-auto">
        ...
        {/* Header */}
        <ScrollReveal yOffset={30} className="text-center mb-16">
        ...
        {/* Accordion List */}
        <StaggerContainer staggerDelay={0.06} className="space-y-4 text-left">
        ...
        {/* Direct Help Callout */}
        <ScrollReveal yOffset={20} className="mt-12">
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 text-left">
            <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="border border-slate-300 hover:bg-slate-50 text-slate-700 text-xs font-bold uppercase tracking-wider px-4 py-3 rounded-full flex items-center gap-2 hover:scale-105 active:scale-95 transition-transform"
              >
                <Phone size={14} />
                <span>Call Us</span>
              </a>
