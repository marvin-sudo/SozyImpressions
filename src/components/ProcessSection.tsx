      ...
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#2E3192] to-[#ED008C] flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                    {step.icon}
                  </div>
                </div>
        ...
        >
          <button
            ...
            className="bg-[#ED008C] hover:bg-[#d4007d] text-white font-heading font-bold text-xs uppercase tracking-wider px-8 py-4 rounded-full shadow-lg shadow-[#ED008C]/25 transition-all hover:-translate-y-0.5 inline-flex items-center gap-2"
          >
