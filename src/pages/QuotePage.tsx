          ...
          <div className="lg:col-span-5 space-y-6 sticky top-24">
            ...
            <div className="bg-gradient-to-br from-[#181B34] to-[#2D3094] text-white rounded-3xl p-6 md:p-8 border border-white/15 shadow-2xl space-y-6">
              ...
              <div className="space-y-3">
                <a
                  href={`https://wa.me/256708000000?text=Hello%20Sozy%20Impressions!%20I%20generated%20a%20quote%20for%20${quantity}%20units%20of%20${encodeURIComponent(productType)}%20with%20${encodeURIComponent(finishing)}.%20Est.%20Price:%20UGX%20${calculation.totalUGX.toLocaleString()}.`}
                  target="_blank"
