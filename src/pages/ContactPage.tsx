          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#181B34] to-[#2D3094] text-white p-6 rounded-3xl border border-white/10 shadow-md">
              ...
              <button
                ...
                className="w-full bg-white text-[#181B34] hover:bg-slate-100 font-heading font-bold text-xs uppercase tracking-wider py-3 rounded-xl transition-all shadow-sm"
              >
                Launch RFQ Portal
              </button>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full bg-[#ED008C] hover:bg-[#d4007d] text-white font-heading font-bold text-xs uppercase tracking-wider py-4 rounded-xl shadow-lg shadow-[#ED008C]/25 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
