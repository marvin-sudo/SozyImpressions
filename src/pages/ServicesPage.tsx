...
import { ScrollReveal, StaggerContainer, StaggerItem, ImageReveal } from '../components/ScrollReveal';
    ...
    <div className="w-full bg-[#F7F8FA] min-h-screen py-12 px-4 md:px-8 font-sans text-left">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <ScrollReveal direction="left" duration={0.75} className="lg:col-span-4 space-y-3 sticky top-24">
            <div>
          ...
          <ScrollReveal direction="right" duration={0.8} className="lg:col-span-8 space-y-8">
            <div className="bg-white rounded-3xl p-6 md:p-10 border border-slate-200 shadow-xl">
              ...
              <div className="mb-8">
                ...
                <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {activeService.popularProducts.map((item, idx) => (
                    <StaggerItem key={idx}>
                      <div className="flex items-start gap-2 bg-slate-50 p-3 rounded-xl border border-slate-100 text-xs text-slate-700 h-full">
        ...
        <ScrollReveal yOffset={35} className="mt-16 bg-white rounded-3xl p-4 md:p-8 border border-slate-200 shadow-xl overflow-hidden">
