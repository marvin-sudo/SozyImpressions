          ...
          {filteredProjects.map((project) => (
            <StaggerItem key={project.id}>
              <div
                ...
                className="bg-white rounded-3xl overflow-hidden border border-slate-200 hover:border-[#2D3094]/50 shadow-sm hover:shadow-2xl transition-all duration-300 cursor-pointer group flex flex-col justify-between h-full"
              >
                <div>
        ...
        <ScrollReveal yOffset={25}>
          <div className="p-8 rounded-3xl bg-white border border-slate-200 text-center max-w-xl mx-auto shadow-sm">
            ...
            <button
              ...
              className="bg-[#ED008C] hover:bg-[#d4007d] text-white font-bold text-xs uppercase tracking-wider px-8 py-3.5 rounded-full shadow-md transition-all hover:scale-105"
            >
